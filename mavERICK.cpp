...
void physics(Game *g)
{
...
#ifdef USE_OPENAL_SOUND
	if (score >= 100000 && scoreCounter == 0) {
	    score100();
	    scoreCounter = scoreCounter + 1;
	}
	else if (score >= 250000 && scoreCounter2 == 0) {
	    score250();
	    scoreCounter2 = scoreCounter2 + 1;
	}
	else if (score >= 500000 && scoreCounter3 == 0) {
	    score500();
	    scoreCounter3 = scoreCounter3 + 1;
	}
	else if (score >= 1000000 && scoreCounter4 == 0) {
	    score1M();
	    scoreCounter4 = scoreCounter4 + 1;
	}


        else if (score >= 1250000 && scoreCounter2 == 1) {
            score250();
            scoreCounter2 = scoreCounter2 + 1;
        }
        else if (score >= 1500000 && scoreCounter3 == 1) {
            score500();
            scoreCounter3 = scoreCounter3 + 1;
        }
        else if (score >= 2000000 && scoreCounter4 == 1) {
            score1M();
            scoreCounter4 = scoreCounter4 + 1;
        }
	...
	//MaverickShield();
	//MaverickShip();
	if(position5 != 630 || (alienONEHealth != 70 || alienTWOHealth != 70 || alienTHREEHealth != 70)){
	    if (something == 1) {
	    ...
	    if (b % 20 == 0) {
		MaverickCreateTertiaryAliens(g, 3);
	    }
	    b = b+1;
	...
	if (position5 == 632 || position5 == 832) {
	...
	MaverickBossIncomingFill();
	MaverickBossIncomingFillActual();
	MaverickAlienONEFill();
	MaverickAlienONEFillActual();
	MaverickAlienTWOFill();
	MaverickAlienTWOFillActual();
	MaverickAlienTHREEFill();
	MaverickAlienTHREEFillActual();
	...
	MaverickBossIncomingText(yres);
	MaverickHealthText(yres);
	MaverickBoostText(yres);
	MaverickShieldText(yres);
	MaverickAlienHealthText(yres);
	MaverickDangerText(danger);
	MaverickEmptyText(danger2);
	MaverickDepletedText(danger3);
	MaverickShieldFillActual();
	if (won == 1) {
	    winG();
	}
